...
cpfirmware: $(FIRMWARE_FORMAT)
	$(SILENT) || printf "Copying $(TARGET).$(FIRMWARE_FORMAT) to firmware folder" | $(AWK_CMD)
	$(COPY) $(BUILD_DIR)/$(TARGET).$(FIRMWARE_FORMAT) $(FIRMWARE_DIR)/$(CURRENT_KB)/keymaps/$(CURRENT_KM)/$(TARGET).$(FIRMWARE_FORMAT) && $(PRINT_OK)
